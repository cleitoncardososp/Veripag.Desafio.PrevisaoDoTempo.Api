namespace Veripag.Desafio.PrevisaoDoTempo.Api.Aplicacao.Dtos.PrevisaoEstendida
{
    /// <summary>
    /// Objeto recebido pela WeatherApi
    /// </summary>
    public class PrevisaoEstendidaDto
    {
    ...
    public class Astro
    {
        ...
        public double is_moon_up { get; set; }
        public double is_sun_up { get; set; }
    }
